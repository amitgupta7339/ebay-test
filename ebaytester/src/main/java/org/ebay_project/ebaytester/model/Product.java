...
public class Product {
	...
	private int product_id, sub_category_id,category_id,user_id,product_price,product_discount,product_sold_quantity,product_available_quantity,product_rating,product_year;
	private String product_name,product_condition,product_shipping,product_img_url,product_description,deal,brand,color,screen_size,processor,storage,warranty,
	operating_system,gender,applicable,material,clothing_size,style,warranty_type,card_class;
	
	public Product()
	{
	}
		
	public Product(int product_id, int sub_category_id, int category_id,int user_id,  int product_price, int product_discount,
			int product_sold_quantity, int product_available_quantity, int product_rating, int product_year,
			String product_name, String product_condition, String product_shipping, String product_img_url,
